...
/**
 * Zakat & Purification assessment page (M3.7, Pro feature).
 *
 * Wraps the pure-math service shipped in `crates/core/src/portfolio/zakat/`.
 * The Tauri command applies the Pro gate; on Free/Basic the mutation
 * rejects with a GatedError("advanced_reports"), the central UpgradeGate
 * raises a modal, and this page never has to think about the cap.
 *
  ...
  return (
    <Page>
      <PageHeader
        ...
        text={`Computes 2.5% on your zakatable wealth (in ${baseCurrency}) after subtracting short-term debts. Pro feature.`}
      />
      <PageContent>
